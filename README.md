...
1. [Дипломная работа: Russian banks clustering in terms of risk (Spectral, DBSCAN, K-means, Fuzzy C-means, tf-idf, BERT, LDA)](https://github.com/Blausher/show/tree/main/banks_clustering)
